...
";
      ...
      <a href=\"";
                ...
                echo "\" title=\"";
echo _gettext("Open new Larable window");
        ...
        ";
                ...
                if (PhpMyAdmin\Util::showIcons("TabsMode")) {
                    // line 9
                    echo "          ";
                    echo PhpMyAdmin\Html\Generator::getImage("window-new", _gettext("Open new Larable window"));
                    echo "
        ";
                } else {
                    // line 11
...
";
    ...
    {
        return new Source("", "footer.twig", "C:\\Users\\Admin\\Herd\\phpmyadmin\\templates\\footer.twig");
    }
}
