...
/* home/git_info.twig */
class __TwigTemplate_ccd8b6ec190307dfe98784db2c16a125 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Git revision:");
  ...
  ";
        ...
        if (($context["is_remote_commit"] ?? null)) {
            // line 5
            echo "    <a href=\"";
            echo twig_escape_filter($this->env, PhpMyAdmin\Core::linkURL(twig_sprintf("https://github.com/phpmyadmin/phpmyadmin/commit/%s", twig_escape_filter($this->env, ($context["hash"] ?? null)))), "html", null, true);
...
($context["is_remote_branch"] ?? null)) {
            // line 15
            echo "    ";
            echo twig_sprintf(_gettext("from %s branch"), twig_sprintf("<a href=\"%s\" rel=\"noopener noreferrer\" target=\"_blank\">%s</a>", PhpMyAdmin\Core::linkURL(twig_sprintf("https://github.com/phpmyadmin/phpmyadmin/tree/%s", twig_escape_filter($this->env,             // line 17
